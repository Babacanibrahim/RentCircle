...
const Favorites = () => {
  ...
  if (loading) {
    return (
      // 1. DEĞİŞİKLİK: page-layout yerine w-full ve py-32 ekledik
  ...
  return (
    // 2. DEĞİŞİKLİK: page-layout yerine w-full relative ekledik
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-700/50 pb-6">
          ...
          <button
            ...
            className="btn-slate px-5 py-3 cursor-pointer hover:scale-105 active:scale-95 transition-transform">
            ← İlanlara Dön
          </button>
        </div>

        {favorites.length === 0 ? (
          <div className="cyber-card text-center py-24 bg-[#0f172a]/40 border border-slate-700/50">
