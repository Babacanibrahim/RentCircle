...
const Footer = () => {
  return (
    // pt-12 ve pb-8 değerleri pt-8 ve pb-6 olarak daraltıldı, böylece footer yukarı taşındı
    <footer className="w-full bg-[#0f172a] border-t border-slate-700/50 pt-8 pb-6 mt-auto relative overflow-hidden">
      {/* Arka plan parlama efekti küçültüldü */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {/* Logo ve Sadeleştirilmiş Açıklama (Teknik terimler kaldırıldı) */}
          ...
          {/* Hızlı Linkler (Kategoriler kaldırıldı, fontlar küçültüldü) */}
          <div className="space-y-3">
        ...
        {/* Alt Telif Hakkı (Dinamik Yıl ve Sürüm Bilgisi Temizliği) */}
